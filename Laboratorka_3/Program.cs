...
namespace Laboratorka_3
{
    internal class Program
    {
        ...
        public static int[] Change_five(int[] iArray)
        {
        ...
        {
            for (int i = 0; i < A.Length; i+=2) // Проходження по рядках
            {

                Array.Sort(A[i]);
                Console.WriteLine(); // Перехід на новий рядок після завершення рядка
            }
            return A;
        }
